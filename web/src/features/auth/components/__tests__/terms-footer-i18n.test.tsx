...
await i18n.use(initReactI18next).init({
  ...
  resources: {
    zh: {
      translation: {
        'By clicking sign in, you agree to our': '点击登录即表示您同意我们的',
        'User Agreement': '用户协议',
        and: '和',
        'Privacy Policy': '隐私政策',
      },
...
describe('TermsFooter translations', () => {
  ...
  test('renders the sign-in agreement text and links in Chinese', async () => {
    ...
    assert.equal(renderedText, '点击登录即表示您同意我们的用户协议和隐私政策.')
    assert.deepEqual(
