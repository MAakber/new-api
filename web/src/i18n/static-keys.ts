...
export const STATIC_I18N_KEYS = [
  ...
  'Official source',
  'Community source',
  'npm official catalog',
  'WorkBuddy official catalog',
  'Version source',
  'Enter a version manually',
  'Enter a version manually or choose a source.',
  'Source is metadata unless a verified built-in catalog exists.',
  'Client identity only changes verified client headers.',
  'Select an optional client identity without changing the channel endpoint or request format.',
  'Client identity is determined by channel type.',
  ...
  'Client versions refreshed',
  'Failed to refresh client versions',
  'Failed to load client versions',
  'Use default client version',
  'Use default client platform',
  'Platform changes the compatible client identity headers.',
  'Versions are loaded from the official client source.',
  'Latest official version: {{version}}',
  'Official source checked',
  'Retained cached version',
  'retained selection',
  'Windows x64',
  'macOS x64',
  'macOS arm64',
  ...
  'Type',
  'Usage',
  'Maximum registrations per code',
