...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		{
			rankingRoute.GET("/availability", controller.GetRankingAvailability)
			rankingRoute.GET("/security", controller.GetRankingSecurity)
		}
		...
		apiRouter.POST("/oauth/wechat", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, controller.WeChatAuth)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/register/complete", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, controller.CompleteRegistration)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/avatar", controller.GetAdminUserAvatar)
