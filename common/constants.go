...
func IsRegistrationCodeEnabled() bool {
	return registrationCodeEnabled.Load()
}

func SetRegistrationCodeEnabled(enabled bool) {
	registrationCodeEnabled.Store(enabled)
}
